                        ...
                        <ul class="navbar-nav">
                            ...
                            <li class="hs-has-sub-menu nav-item">
                                ...
                                <div class="hs-sub-menu dropdown-menu navbar-dropdown-menu-borderless" aria-labelledby="dashboardsMegaMenu" style="min-width: 14rem;">
                                    <a class="dropdown-item active" href="index.blade.php">Default</a>
                            ...
                            <div class="d-none d-lg-block">
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-body-height">
                                                ...
                                                <div class="dropdown-item bg-transparent text-wrap">
                                                    <a class="btn btn-soft-dark btn-xs rounded-pill" href="index.blade.php">
                                ...
                                <span class="icon icon-soft-dark icon-xs icon-circle">
                                  <i class="bi-paint-bucket"></i>
                                            ...
                                            <!-- Footer -->
                                            <a class="card-footer text-center" href="index.blade.php">
...
<!-- Mirrored from htmlstream.com/front-dashboard/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 21 Jul 2023 11:26:37 GMT -->
</html>
